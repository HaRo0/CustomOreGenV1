...
public class ModChunkGeneratorJsonLoader extends Loader<SeedStringResource, ChunkGenerator> {

    public ModChunkGeneratorJsonLoader(SeedString<SeedStringResource> seed, Path dataFolder) {
